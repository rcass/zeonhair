...
function themify_index_query_posts() {
	...
	$query_arr = array_merge( array( 'order' => $themify->order, 'orderby' => $themify->orderby ), $query_arr );
	query_posts( apply_filters( 'themify_query_posts_args', http_build_query( $query_arr ) ) );
}
endif;
